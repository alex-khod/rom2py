...
{
    "distutils": {
        "name": "src.formats.sprites._sprites_cy_func",
        "sources": [
            "src\\formats\\sprites\\_sprites_cy_func.pyx"
        ]
    },
    "module_name": "src.formats.sprites._sprites_cy_func"
}
END: Cython Metadata */
...
#define __PYX_HAVE__src__formats__sprites___sprites_cy_func
#define __PYX_HAVE_API__src__formats__sprites___sprites_cy_func
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'src.formats.sprites._sprites_cy_func' */
#define __Pyx_MODULE_NAME "src.formats.sprites._sprites_cy_func"
extern int __pyx_module_is_main_src__formats__sprites___sprites_cy_func;
int __pyx_module_is_main_src__formats__sprites___sprites_cy_func = 0;

/* Implementation of 'src.formats.sprites._sprites_cy_func' */
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_h); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 */
  ...
  /* "src/formats/sprites/_sprites_cy_func.pyx":9
 *     output = np.zeros((h, w), dtype=np.uint8)
 *     cdef Py_ssize_t offset = 0
 *     cdef Py_ssize_t  x = 0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t  y = 0
 ...
 */
  ...
  /* "src/formats/sprites/_sprites_cy_func.pyx":10
 *     cdef Py_ssize_t offset = 0
 *     cdef Py_ssize_t  x = 0
 *     cdef Py_ssize_t  y = 0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t  target_x
 ...
 *         if code > 0:
 */
    __pyx_t_7 = (__pyx_v__byte & 0x3f);
    __pyx_t_8 = (__pyx_v__byte & 0xc0);
...
static int __pyx_pymod_exec__sprites_cy_func(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__sprites_cy_func},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_sprites_cy_func(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_sprites_cy_func(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__sprites_cy_func(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__sprites_cy_func(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__sprites_cy_func(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_sprites_cy_func' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__sprites_cy_func(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_sprites_cy_func", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_src__formats__sprites___sprites_cy_func) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.formats.sprites._sprites_cy_func")) {
      if (unlikely(PyDict_SetItemString(modules, "src.formats.sprites._sprites_cy_func", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "src/formats/sprites/_sprites_cy_func.pyx":4
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.formats.sprites._sprites_cy_func", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.formats.sprites._sprites_cy_func");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
